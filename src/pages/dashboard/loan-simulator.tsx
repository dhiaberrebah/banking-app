                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="mt-1 text-2xl font-semibold text-blue-900">
                      {monthlyPayment.toLocaleString(undefined, { maximumFractionDigits: 2 })} TND
                    </p>
                  </div>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="mt-1 text-2xl font-semibold text-blue-900">
                      {totalInterest.toLocaleString(undefined, { maximumFractionDigits: 2 })} TND
                    </p>
                  </div>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="mt-1 text-2xl font-semibold text-blue-900">
                      {totalPayment.toLocaleString(undefined, { maximumFractionDigits: 2 })} TND
                    </p>
                  </div>
                </div>
                        ...
                        {amortizationSchedule.map((row) => (
                          <tr key={row.month}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                              {row.payment.toLocaleString(undefined, { maximumFractionDigits: 2 })} TND
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                              {row.principal.toLocaleString(undefined, { maximumFractionDigits: 2 })} TND
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                              {row.interest.toLocaleString(undefined, { maximumFractionDigits: 2 })} TND
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                              {row.balance.toLocaleString(undefined, { maximumFractionDigits: 2 })} TND
                            </td>
                          </tr>
                        ))}
                      </tbody>
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-yellow-700">
                      This is a simulation only. Actual loan terms may vary based on your credit score and financial
                      situation. Please contact our loan department for more information.
                    </p>
                  </div>
                </div>
              </div>
