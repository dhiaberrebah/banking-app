...
const ServicesPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
              ...
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
                <div className="px-6 py-8 flex-auto">
                  ...
                  <a
                    ...
                    className="mt-2 inline-flex items-center text-green-700 hover:text-green-800"
                  >
                    Learn more
      ...
      {/* CTA Section */}
      <section className="relative block py-24 lg:pt-0 bg-green-700">
        <div className="container mx-auto px-4">
            ...
            <div className="w-full lg:w-6/12 px-4">
              <div className="bg-white text-center rounded-lg p-8 shadow-lg">
                ...
                <div className="mt-6 flex flex-col sm:flex-row justify-center gap-4">
                  ...
                  <a
                    href="/contact"
                    className="inline-flex items-center justify-center px-5 py-3 border border-gray-300 text-base font-medium rounded-md text-green-700 bg-white hover:bg-gray-50 transition-colors"
                  >
                    Contact Us
                  </a>
                </div>
